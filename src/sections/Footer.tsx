        ...
        <div className="grid w-full grid-cols-1 gap-8 sm:gap-16 text-lg md:grid-cols-12"> 
            ...
            <div className="flex flex-col md:col-span-6">
                ...
                <ul className="flex flex-col gap-y-4">
                    ...
                    <li key={item}>
                        <a className="group relative block h-fit  overflow-hidden font-light cursor-pointer select-none flex w-fit leading-base text-[var(--color-secondary-100)] sm:leading-snug"> 
